...
function getHistoricoCpu(historicParams){
...
function getHistoricoRam(historicParams){
    fetch(`/hardware/getHistoric`, { 
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
function getHistoricoRamProc(historicParams){
  fetch(`/hardware/getHistoric`, { 
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
function getHistoricoDisc(historicParams){
  fetch(`/hardware/getHistoric`, { 
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
function cpuHistFilter(){
  getHistoricoCpu(cpuHistFilterPeriod());
}

function ramHistFilter(){
  getHistoricoRam(ramHistFilterPeriod());
}

function ramProcHistFilter(){
  getHistoricoRamProc(ramProcHistFilterPeriod());
}
